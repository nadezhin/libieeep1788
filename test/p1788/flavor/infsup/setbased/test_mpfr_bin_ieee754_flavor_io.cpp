...
{
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(F<double>::empty()), "[empty]" ) ;
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(-INF_D,INF_D)), "[entire]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(-3,INF_D)), "[-0x1.8p1,inf]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(-INF_D,5)), "[-inf,0x1.4p2]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p13"),std::stod("0x5p13"))), "[-0x1.8p14,0x1.4p15]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p12"),std::stod("0x5p12"))), "[-0x1.8p13,0x1.4p14]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p11"),std::stod("0x5p11"))), "[-0x1.8p12,0x1.4p13]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p10"),std::stod("0x5p10"))), "[-0x1.8p11,0x1.4p12]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p0"),std::stod("0x5p0"))), "[-0x1.8p1,0x1.4p2]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p-1"),std::stod("0x5p-1"))), "[-0x1.8p0,0x1.4p1]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p-2"),std::stod("0x5p-2"))), "[-0x1.8p-1,0x1.4p0]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p-3"),std::stod("0x5p-3"))), "[-0x1.8p-2,0x1.4p-1]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p-4"),std::stod("0x5p-4"))), "[-0x1.8p-3,0x1.4p-2]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x3p-1030"),std::stod("0x5p-1030"))), "[-0x0.03p-1022,0x0.05p-1022]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x1p13"),std::stod("0x1p13"))), "[-0x1p13,0x1p13]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x1p12"),std::stod("0x1p12"))), "[-0x1p12,0x1p12]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x1p11"),std::stod("0x1p11"))), "[-0x1p11,0x1p11]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x1p10"),std::stod("0x1p10"))), "[-0x1p10,0x1p10]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x1p0"),std::stod("0x1p0"))), "[-0x1p0,0x1p0]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x1p-1"),std::stod("0x1p-1"))), "[-0x1p-1,0x1p-1]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP<double>(std::stod("-0x1p-2"),std::stod("0x1p-2"))), "[-0x1p-2,0x1p-2]" );
...
{
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(F<double>::nai()), "[nai]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP_DEC<double>(F<double>::empty(), DEC::trv)), "[empty]" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP_DEC<double>(REP<double>(-INF_D,INF_D), DEC::dac)), "[entire]_dac" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP_DEC<double>(REP<double>(-INF_D,INF_D), DEC::def)), "[entire]_def" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP_DEC<double>(REP<double>(-INF_D,INF_D), DEC::trv)), "[entire]_trv" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP_DEC<double>(REP<double>(-3,5), DEC::com)), "[-0x1.8p1,0x1.4p2]_com" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP_DEC<double>(REP<double>(-3,5), DEC::dac)), "[-0x1.8p1,0x1.4p2]_dac" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP_DEC<double>(REP<double>(-3,5), DEC::def)), "[-0x1.8p1,0x1.4p2]_def" );
    BOOST_CHECK_EQUAL( F<double>::interval_to_exact(REP_DEC<double>(REP<double>(-3,5), DEC::trv)), "[-0x1.8p1,0x1.4p2]_trv" );
}
...
BOOST_AUTO_TEST_CASE(minimal_interval_input_test)
{
    ...
    {
        REP<double> i;
        std::istringstream is("[ ENTIRE ]foo");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL(i, REP<double>(-INF_D,INF_D) );
        BOOST_CHECK(is);
    }
    ...
    {
        REP<double> i;
        std::istringstream is("[ -inf, INFinity ]");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL(i, REP<double>(-INF_D,INF_D) );
        BOOST_CHECK(is);
    }
    ...
    {
        REP<double> i(3.5,4.7);
        std::istringstream is("[ -infInItY ,  INF ]");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL( i, REP<double>(-INF_D,INF_D) );
        BOOST_CHECK(is);
    }
    ...
    {
        REP<double> i;
        std::istringstream is("[  -1.0  , 0x1.0p0]");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL(i, REP<double>(-1.0,1.0));
        BOOST_CHECK(is);
    }
    ...
    {
        REP<double> i;
        std::istringstream is("[-1.0, +infinity]");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL(i, REP<double>(-1.0,INF_D));
        BOOST_CHECK(is);
    }
    ...
    {
        REP<double> i;
        std::istringstream is("[-Infinity, 1.000 ]");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL(i, REP<double>(-INF_D,1.0));
        BOOST_CHECK(is);
    }
    ...
    {
        REP<double> i;
        std::istringstream is("[ -1/10, 1/10 ]");
        F<double>::operator_text_to_interval(is, i);
...
BOOST_AUTO_TEST_CASE(minimal_uncertain_interval_input_test)
{
...

    {
        ...
        std::istringstream is("0.0?u_trv");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL(i, REP<double>(0,0.05));
        BOOST_CHECK(is);
    }

    {
        REP<double> i;
        std::istringstream is("0.0?dfoo");
        F<double>::operator_text_to_interval(is, i);
    ...
    {
        REP<double> i;
        std::istringstream is("2.500?5ue4");
        F<double>::operator_text_to_interval(is, i);
...

    {
        ...
        std::istringstream is("0.0??ufoo");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL( i, REP<double>(0,INF_D) );
        BOOST_CHECK(is);
    }

    {
        REP<double> i(-2.0,-1.0);
        std::istringstream is("\t0.0??d_trv");
        F<double>::operator_text_to_interval(is, i);
        BOOST_CHECK_EQUAL( i, REP<double>(-INF_D,0.0) );
        BOOST_CHECK(is);
    }
